...
class MultiplicationTableBuilderTest {
    ...
    @Test
    void should_return_true_when_isStarterNotBiggerThanEnd_given_start_3_and_end_3() {
        // Given
        MultiplicationTableBuilder multiplicationTableBuilder = new MultiplicationTableBuilder();
        int start = 3;
        int end = 3;
    ...
    @Test
    void should_return_string_when_generateExpression_given_start_2_and_end_4(){
        // Given
        MultiplicationTableBuilder multiplicationTableBuilder = new MultiplicationTableBuilder();
        int start = 2;
        int end = 4;
